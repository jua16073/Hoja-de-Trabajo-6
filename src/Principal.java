...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Los desarrolladores que no trabajan en Java son, pero si en iOS y Android son:");
		...
		System.out.println("La afirmacion: Los Desarrolladores Android son subconjunto de Java es:");
		System.out.println(listas.sub());
		System.out.println("El conjunto que mas tiene es: ");
